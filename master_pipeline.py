...
NB_DIR = r'P:\Application\Risk Mgmt\MRM\ARMS\python'

# All Excel files that must be updated today to trigger the pipeline
EXCEL_PORTFOLIO  = os.path.join(NB_DIR, 'securities_portfolio.xlsx')
EXCEL_BLOOMBERG  = os.path.join(NB_DIR, 'Source_Data_Bloom.xlsx')
EXCEL_OAS_EM     = r'P:\Application\Risk Mgmt\MRM\ARMS\arms_data_storage\Emustruuindex.xlsx'
EXCEL_OAS_GLOBAL = r'P:\Application\Risk Mgmt\MRM\ARMS\arms_data_storage\I04064US_index.xlsx'
